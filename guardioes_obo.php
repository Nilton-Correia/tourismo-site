...
<main id="main">
    ...
    <section id="about" class="about">
        <div class="container">
            ...
            <div class="section-title">
                <h2>GUARDIÕES D'OBÔ</h2>
            </div>

            <h5>
                OS 12 GUARDIÕES D’OBÔ – equipa criada para fiscalizar, monitorar, sensibilizar e zelar pelo conservção e preservação do PNOST e suas Zonas Tampão.

            </h5>

            <p>  Esta iniciativa surge no âmbito do cumprimento do Memorando de Entendimento assinado entre a PTRS e o Governo, através do Ministério  de Agricultura, Pescas e Desenvolvimento Rural e do Ministério de Turismo, Cultura, Comércio e Indústria, cujo objetivo é apoiar e reforçar a intervenção das autoridades públicas, ao nível da  conservação e preservação de áreas protegidas em S. Tomé e Príncipe.
            </p>


            <div class="row content">
                <div class="col-lg-6">
                   <h3>Atividades desenvolvidas pelos Guardiões:
                   </h3>
                    <ul>
                        <li><i class="ri-check-double-line"></i> Patrulhas de fiscalização das atividades humanas dentro do Parque;
                        </li>
                        <li><i class="ri-check-double-line"></i> Sensibilização Comunitaria;
                        </li>
                        <li><i class="ri-check-double-line"></i>Monitorização da Biodiversidade;
                        </li>
                        <li><i class="ri-check-double-line"></i>Apoio logístico à estudos e atividades científicas nas áreas protegidas do Parque Natural Obô de S. Tomé (PNOST);
                        </li>
                        <li><i class="ri-check-double-line"></i>Manutenção de trilhos e de infraestruturas dentro do PNOST e suas Zonas Tampão.
                        </li>
    ...
    <section id="team" class="team">
        <div class="container">
            ...
            <div class="section-title" data-aos="fade-in" data-aos-delay="100">
                <h2>Guardiões em patrulhas de fiscalização do Obô de atividades humanas no Parque Obô</h2>
            </div>
    ...
    <section id="team" class="team">
        <div class="container">
            ...
            <div class="section-title" data-aos="fade-in" data-aos-delay="100">
                <h2>Guardiões em patrulhas de fiscalização de atovidades humanas no Parque Obô</h2>
            </div>
    ...
    <section id="team" class="team">
        <div class="container">
            ...
            <div class="section-title" data-aos="fade-in" data-aos-delay="100">
                <h2> Guardiões na Monitorização da Biodiversidade</h2>
            </div>
